    ...
    <section class="services style2 section">
        <div class="container">
            ...
            <div class="row">
                 ...
                 <a href="{{ route('contract.subCategorieType', $categorie->id) }}" class="subCat">
                    ...
                    <div class="service-icon">
                        ...
                        <!-- @if($categorie['subCategories'])
                            @foreach ($categorie['subCategories'] as $subCategorie)
                                <p><i class="lni lni-star-filled"></i> <a href="{{ route('contract.type', $subCategorie->id) }}" class="subCat">{{$subCategorie->sub_categories_name}}</a></p>
                            @endforeach   
                        @endif -->
                    </div>
                    </a>
                        ...
                        <div class="single-team">
                            ...
                            <div class="content">
                                ...
                                <ul class="social">
                                    ...
                                    <li><a href="{{ $team->twitter }}"><i class="lni lni-twitter-original"></i></a></li>
