        ...
        <div class="container">
            ...
            <div class="step-process mx-md-auto">
                <ul class="nav nav-pills mb-4" id="pills-tab" role="tablist">
                    ...
                    ?>
                     <input type="hidden" id="progress_val_{{$temp_name}}" name="progress_val_{{$templates->template_name}}" value="{{$prog}}"> 
                    <li class="nav-item" role="presentation">
                      <button class="nav-link <?php if($i==1){echo "active";} ?>" id="pills-property-tab-{{$temp_name}}" data-bs-toggle="pill" data-bs-target="#pills-{{$temp_name}}" type="button" role="tab" aria-controls="pills-property" aria-selected="<?php if($i==1){echo "true";}else{echo "false";} ?>">{{$templates->template_name}}</button></li>
                    <?php $i++; ?>
                    @endforeach
                    @endif
                    <li class="nav-item" role="presentation">
                ...
                <div class="vehicle-details-area tab-pane fade <?php if($f==1){echo "show active";} ?> " id="pills-{{$template_name}}" role="tabpanel" aria-labelledby="pills-property-tab-{{$template_name}}">
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <!-- <a href="#!" class="skip-content" id="pills-property-tab" data-bs-toggle="pill" data-bs-target="#pills-{{$position_no}}" role="tab" aria-controls="pills-property">Skip this step for now</a> -->
                            </div>
                           </form>
                        ...
                        <div class="col-lg-6 my-4 mt-lg-0">
                            <div class="faq-area">
                                ...
                                @foreach ($templates->templateQuestions as $questions)
                                        ...
                                        <!-- <li class="mb-3"><a href="javascript:void(0)" data-val="{{$questions->description}}" data-teml="{{$templates->template_name}}_{{$questions->id}}" class="questions"></a>
...
@section('js_section')
    <script>
        ...
        window.preview = "{{ route('contract.preview') }}";
    </script>
@endsection
