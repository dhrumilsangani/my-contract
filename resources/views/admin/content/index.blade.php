                      ...
                      <div class="toolbar row mb-3">
                        <div class="col">
                          <form class="form-inline" action="" method="GET" role="search">
                            ...
                            <a href="{{ url('/admin/content_management') }}" class="btn btn-secondary">Reset</a>
                          </form>
                        </div>
                        <div class="col ml-auto">
                          <div class="dropdown float-right">
                            
                            <!-- <a class="btn btn-primary float-right ml-3" href="{{url('/admin/add_content')}}">Add Content +</a> -->
                          </div>
                        </div>
                      </div>
                      <!-- table -->
            ...
            if(!empty($data)){
                ...
                foreach ($data as $key => $value) { ?>
                    <tr>
                        ...
                        <td><?php if(!empty($value->content)) echo htmlspecialchars_decode($value->content); ?></td>
                        <td>{{$value->status == 1?"Active":"Inactive"}}</td>
                        <td class="text-center">
                            <a class="mr-1" href="{{url('admin/edit_content/'.$value->id)}}" alert="Edit"><i class="fe fe-edit fe-16"></i></a>
                        </td>
                    </tr>
            <?php 
                $i++;
