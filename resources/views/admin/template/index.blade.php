            ...
            <div class="col-12">
              ...
              <div class="row">
                ...
                <div class="col-md-12 my-4">
                  <h2 class="h4 mb-1">Questionnaire Template Management</h2>
                      ...
                      <div class="toolbar row mb-3">
                        <div class="col">
                          <form class="form-inline" action="" method="GET" role="search">
                            ...
                            <a href="{{ url('/admin/template_management') }}" class="btn btn-secondary">Reset</a>
                          </form>
                        </div>
                        <div class="col ml-auto">
                          <div class="dropdown float-right">
                            
                            <a class="btn btn-primary float-right ml-3" href="{{url('/admin/template/create')}}">Add template +</a>
                          </div>
                        </div>
                      </div>
                      <!-- table -->
            ...
            if(!empty($data)){
                ...
                foreach ($data as $key => $value) { ?>
                    ...
                    ?>
                         ...
                         <td>{{ !empty($value->status) && $value->status == 1 ? "Active":"Inactive" }}</td>
                        <!-- <td>
                        ...
                        <td class="text-center">
                            <a class="mr-1" href="{{url('admin/edit_template/'.$value->id)}}" alert="Edit"><i class="fe fe-edit fe-16"></i></a>
                            <a href="{{url('admin/view_template/'.$value->id)}}" alert="view"><i class="fe fe-file fe-16"></i></a>
                        </td>
                    </tr>
            <?php 
                $i++;
