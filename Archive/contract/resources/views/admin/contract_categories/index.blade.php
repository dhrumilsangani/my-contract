                      ...
                      <div class="toolbar row mb-3">
                        <div class="col">
                          <form class="form-inline" action="" method="GET" role="search">
                            ...
                            <a href="{{ url('/admin/categories_management') }}" class="btn btn-secondary">Reset</a>
                          </form>
                        </div>
                        <div class="col ml-auto">
                          <div class="dropdown float-right">
                            
                            <a class="btn btn-primary float-right ml-3" href="{{url('/admin/add_categories')}}">Add category +</a>
                          </div>
                        </div>
                      </div>
                      <!-- table -->
                ...
                foreach ($data as $key => $value) { ?>
                    <tr>
                        ...
                        <td class="text-center">
                            <a class="mr-2" href="{{url('admin/edit_categories/'.$value->id)}}" alert="Edit"><i class="fe fe-edit fe-16"></i></a>
